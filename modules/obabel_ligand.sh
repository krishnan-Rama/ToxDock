...
INPUT_DIR=/mnt/scratch/c23048124/Orthofinder/swissmodel_results/sdf_files
OUTPUT_DIR=/mnt/scratch/c23048124/Orthofinder/swissmodel_results/pdbqt_ligand_files
...
for pdb_file in ${INPUT_DIR}/*.sdf; do
    output_file=${OUTPUT_DIR}/$(basename ${pdb_file} .sdf).pdbqt
    OBABEL_COMMAND="obabel ${pdb_file} -opdbqt ${output_file} -h -m -r -s"
